...
shiny::fluidPage(
  ...
  shiny::tabsetPanel(id="tabs",
              shiny::tabPanel("Fastp execution",
                       ...
                       shinyFiles::shinyDirButton("fastq_dir", "Fastq Directory", "Select fastq directory"),
                       shiny::verbatimTextOutput("fastq_dir"),
                       shinyFiles::shinyDirButton("result_dir", "Result Directory", "Select result directory"),
                       shiny::verbatimTextOutput("result_dir"),
                       shiny::textInput("file_pattern", "File Pattern", value = "_[12]" ),
                       shiny::actionButton("runButton", "Run Rfastp as paired")
                       #,
                       # Area of logs
                       # uiOutput("dynamicSizeLogOutput")
              ),
              shiny::tabPanel("Overview",
                       shiny::selectInput("overview_item", "Select item", choices = c("total_reads", "total_bases", "q20_bases", "q30_bases", "q20_rate", "q30_rate", "read1_mean_length", "read2_mean_length", "gc_content") ),
